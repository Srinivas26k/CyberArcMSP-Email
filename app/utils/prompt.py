...
def build_email_prompt(
    ...
    user_prompt = (
        ...
        "3. <p>COMPANY NARRATIVE — 1-2 sentences ONLY. STYLE RULES:\n"
        "   DO:\n"
        "     - Open with: 'Given " + company + "'s [scale / domain / responsibility],'\n"
        "       or 'As a " + size_label + " in " + industry + ", " + company + " ...'\n"
        "     - Name ONE key pressure " + industry + " " + size_label + "s face today\n"
        "       (e.g. rising cyber threats, cloud complexity, talent gaps, AI adoption,\n"
        "       compliance culture, supply-chain risk — story language only).\n"
        "     - Close with: 'I believe " + (sender_org or "we") + " can offer meaningful\n"
        "       value to your [transformation / security / innovation] agenda.'\n"
        "   DO NOT:\n"
        "     - Quote any statistic, percentage, year deadline, or law name.\n"
        "     - Write '38 states', '72-hour window', 'SOC 2 by 2026', etc.\n"
        "     - Invent facts about " + company + ".</p>\n\n"
